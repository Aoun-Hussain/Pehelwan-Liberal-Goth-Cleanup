...
GameWinScreen::GameWinScreen(Ltexture* bgImage,Ltexture* buttonTexture, Ltexture* fontSprite) : Screen(fontSprite)
{
...
void GameWinScreen::Render(long int& frame, long int& frame1, SDL_Renderer* gRenderer)
{
